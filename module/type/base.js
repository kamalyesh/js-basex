    ...
    converter: {
        ...
        getBaseFromTextChar: (textChar) => {
            switch (textChar) {
                ...
                case 'A': return Base.eBase.A;
                case 'B': return Base.eBase.B;
                case 'C': return Base.eBase.C;
                case 'D': return Base.eBase.D;
                case 'E': return Base.eBase.E;
                case 'F': return Base.eBase.F;
                
                case 'G': return Base.eBase.G;
                case 'H': return Base.eBase.H;
                case 'I': return Base.eBase.I;
                case 'J': return Base.eBase.J;
                case 'K': return Base.eBase.K;
                case 'L': return Base.eBase.L;
                case 'M': return Base.eBase.M;
                case 'N': return Base.eBase.N;
                case 'O': return Base.eBase.O;
                case 'P': return Base.eBase.P;
                case 'Q': return Base.eBase.Q;
                case 'R': return Base.eBase.R;
                case 'S': return Base.eBase.S;
                case 'T': return Base.eBase.T;
                case 'U': return Base.eBase.U;
                case 'V': return Base.eBase.V;
                case 'W': return Base.eBase.W;
                case 'X': return Base.eBase.X;
                case 'Y': return Base.eBase.Y;
                case 'Z': return Base.eBase.Z;
